...
// WrapConnClient has moved to transport/internet/security: one deep entry
// point layers the TCP mask chain and client TLS/REALITY in a fixed
// mask-before-security order.
