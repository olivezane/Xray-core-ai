...
//
//	mockgen -package mocks -destination ../testing/mocks/outbound.go -mock_names Manager=OutboundManager,HandlerSelector=OutboundHandlerSelector github.com/xtls/xray-core/features/outbound Manager,HandlerSelector
//
...
func (m *OutboundManager) ListHandlers(ctx context.Context) []outbound.Handler {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListHandlers", ctx)
	ret0, _ := ret[0].([]outbound.Handler)
	return ret0
}

// ListHandlers indicates an expected call of ListHandlers.
func (mr *OutboundManagerMockRecorder) ListHandlers(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListHandlers", reflect.TypeOf((*OutboundManager)(nil).ListHandlers), ctx)
}
