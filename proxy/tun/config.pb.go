...
type Config struct {
	...
	TcpCongestion          string                 `protobuf:"bytes,10,opt,name=tcp_congestion,json=tcpCongestion,proto3" json:"tcp_congestion,omitempty"`
...
func (x *Config) GetTcpCongestion() string {
	if x != nil {
...
const file_proxy_tun_config_proto_rawDesc = "" +
	"\n" +
	"\x16proxy/tun/config.proto\x12\x0exray.proxy.tun\"\xbf\x02\n" +
	"\x06Config\x12\x12\n" +
	...
	"\x05stack\x18\t \x01(\tR\x05stack\x12%\n" +
	"\x0etcp_congestion\x18\n" +
	" \x01(\tR\rtcpCongestionBL\n" +
