...
// Stack is the user-space IP stack behind a TUN inbound. It turns the IP
// packets of a TUN device into transport connections and hands them to the
// inbound's ConnectionHandler.
